...
def test_main_2():
    ...
    obj = fernetWrapper.StringEncryptor(password)
...
def test_compatible_returnString():
    ...
    for string , password , encString in pickledList:
        ...
        decString = fernetWrapper.StringEncryptor(password).decrypt_string(encString)
...
def test_compatible_returnString_2():
    ...
    for string , password , encString in pickledList:
        ...
        gen = fernetWrapper.StringEncryptor(password).decrypt_string_yield(encString)
...
def test_compatible_returnByte():
    ...
    for string , password , encByte in pickledList:
        ...
        decString = fernetWrapper.StringEncryptor(password).decrypt_byte(encByte)
...
def test_compatible_returnByte_2():
    ...
    for string , password , encByte in pickledList:
        ...
        gen = fernetWrapper.StringEncryptor(password).decrypt_byte_yield(encByte)
