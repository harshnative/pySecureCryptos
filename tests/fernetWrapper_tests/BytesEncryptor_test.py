...
def test_main():
    ...
    obj = fernetWrapper.BytesEncryptor(password)
...
def test_compatible():
    ...
    fileName = "binFiles/fernetWrapper_testcases_bin/BytesEncryptor_test_testCases.bin"
    ...
    for byte , password , encByte in pickledList:
        ...
        decByte = fernetWrapper.BytesEncryptor(password).decrypt(encByte)
