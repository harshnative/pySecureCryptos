...
# function to test Base64_16 yield encode with Base64_16 decode
@pytest.mark.repeat(repeatTimes.RepeatTime.value)
def test_main():

    byte = getRandomByte()

    genObj = encoderDecoders.Base64_16.encode_yield(byte)
    ...
    byteAgain = encoderDecoders.Base64_16.decode(stringFromByte)
...
# function to test Base64_16 encode with Base64_16 yield decode
@pytest.mark.repeat(repeatTimes.RepeatTime.value)
def test_main_2():
    ...
    genObj = encoderDecoders.Base64_16.decode_yield(stringFromByte)
...
# function to test Base64_16 yield encode with Base64_16 yield decode
@pytest.mark.repeat(repeatTimes.RepeatTime.value)
def test_main_3():
...
def test_compatible_1():
    ...
    fileName = "binFiles/encoderDecoder_testcases_bin/Base64_16_yield_test_testCases.bin"
    ...
    for byte , encodedByte in pickledList:
        ...
        byteAgain = encoderDecoders.Base64_16.decode(encodedByte)
...
def test_compatible_2():
    ...
    for byte , encodedByte in pickledList:
        ...
        gen = encoderDecoders.Base64_16.encode_yield(byte)
...
def test_compatible_3():
    ...
    for byte , encodedByte in pickledList:
        ...
        gen = encoderDecoders.Base64_16.decode_yield(encodedByte)
