...
def test_main():
    ...
    gen = verifier_onetimepadWrapper.BytesEncryptor_yield.encrypt(byte , password , returnByteObject=True)
    ...
    gen = verifier_onetimepadWrapper.BytesEncryptor_yield.encrypt(byte , password , returnByteObject=False)
...
def test_main2():
    ...
    gen = verifier_onetimepadWrapper.BytesEncryptor_yield.decrypt_byte(encByte , password)
    ...
    gen = verifier_onetimepadWrapper.BytesEncryptor_yield.decrypt(encString , password)
...
def test_compatible():
    ...
    fileName = "binFiles/verifier_onetimepadWrapper_testcases_bin/BytesEncryptor_yield_test_testCases_1.bin"
...
def test_compatible_2():
    ...
    fileName = "binFiles/verifier_onetimepadWrapper_testcases_bin/BytesEncryptor_yield_test_testCases_2.bin"
