...
def test_main():
    ...
    gen = onetimepadWrapper.BytesEncryptor_yield.encrypt(byte , password , returnByteObject=True)
    ...
    gen = onetimepadWrapper.BytesEncryptor_yield.encrypt(byte , password , returnByteObject=False)
    ...
    decByte = onetimepadWrapper.BytesEncryptor.decrypt_byte(encByte , password)
    decByte2 = onetimepadWrapper.BytesEncryptor.decrypt(encString , password)
...
def test_main2():
    ...
    encByte = onetimepadWrapper.BytesEncryptor.encrypt(byte , password , returnByteObject=True)

    encString = onetimepadWrapper.BytesEncryptor.encrypt(byte , password , returnByteObject=False)

    gen = onetimepadWrapper.BytesEncryptor_yield.decrypt_byte(encByte , password)
    ...
    gen = onetimepadWrapper.BytesEncryptor_yield.decrypt(encString , password)
...
def test_compatible():
    ...
    fileName = "binFiles/onetimepadWrapper_testcases_bin/BytesEncryptor_yield_test_testCases_1.bin"
...
def test_compatible_2():
    ...
    fileName = "binFiles/onetimepadWrapper_testcases_bin/BytesEncryptor_yield_test_testCases_2.bin"
    ...
    for byte , password , encString in pickledList:
        ...
        decByte = onetimepadWrapper.BytesEncryptor.decrypt(encString , password)
