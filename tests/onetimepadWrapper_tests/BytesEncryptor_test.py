...
def test_compatible():
    ...
    fileName = "binFiles/onetimepadWrapper_testcases_bin/BytesEncryptor_test_testCases_1.bin"
...
def test_compatible_2():
    ...
    fileName = "binFiles/onetimepadWrapper_testcases_bin/BytesEncryptor_test_testCases_2.bin"
