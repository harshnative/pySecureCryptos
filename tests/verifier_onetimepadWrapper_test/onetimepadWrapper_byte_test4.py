...
from pySecureCryptos.verifier_onetimepadWrapper import BytesEncryptor_yield as BytesEncryptor
...
def byteEncryptorTest_func(writeErrors = True):
    ...
    for k in filesList:
        ...
        genObj = BytesEncryptor.encrypt(data , randString1 , returnByteObject=True)
        ...
        genObj = BytesEncryptor.decrypt_byte(encrytedByte , randString1)
