...
from pySecureCryptos.verifier_onetimepadWrapper import BytesEncryptor
...
def byteEncryptorTest_func(howManyTimes , writeErrors = True):
    ...
    for k in range(howManyTimes):
        ...
        encrytedByte = BytesEncryptor.encrypt(randomByte , randString1 , returnByteObject=True)

        decryptedByte = BytesEncryptor.decrypt_byte(encrytedByte , randString1)
