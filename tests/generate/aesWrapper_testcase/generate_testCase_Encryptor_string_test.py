...
def main():
    ...
    fileName = "binFiles/aesWrapper_testcases_bin/Encryptor_string_test_testCases.bin"
    ...
    for i in range(number):
        ...
        enc_string = aesWrapper.Encryptor(password).encrypt_string(string)
...
def main2():
    ...
    fileName = "binFiles/aesWrapper_testcases_bin/Encryptor_string_yield_test_testCases.bin"
