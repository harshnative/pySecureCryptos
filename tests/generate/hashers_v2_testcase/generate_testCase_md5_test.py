...
def main():
    ...
    for i in range(number):
        ...
        hashed_byte = hashers.MD5(byte).get_byte()

        genObj = hashers.MD5(byte).get_byte_yield()
        ...
        hashed_string = hashers.MD5(byte).get_string()

        genObj = hashers.MD5(byte).get_string_yield()
