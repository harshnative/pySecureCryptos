...
def main():
    ...
    fileName = "binFiles/verifier_fernetWrapper_testcases_bin/StringEncryptor_test_testCases_1.bin"
    ...
    for i in range(number):
        ...
        encString = verifier_fernetWrapper.StringEncryptor(password).encrypt(string , returnString=True)
...
def main2():
    ...
    fileName = "binFiles/verifier_fernetWrapper_testcases_bin/StringEncryptor_test_testCases_2.bin"
    ...
    for i in range(number):
        ...
        encString = verifier_fernetWrapper.StringEncryptor(password).encrypt(string , returnString=False)
        outputList.append([string , password , encString])
