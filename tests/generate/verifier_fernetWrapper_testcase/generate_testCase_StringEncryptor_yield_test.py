...
def main():
    ...
    for i in range(number):
        ...
        gen = verifier_fernetWrapper.StringEncryptor(password).encrypt_yield(string , returnString=True)
...
def main2():
    ...
    for i in range(number):
        ...
        gen = verifier_fernetWrapper.StringEncryptor(password).encrypt_yield(string , returnString=False)
