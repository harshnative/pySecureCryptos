...
def main():
    ...
    fileName = "binFiles/aesWrapper_v2_testcases_bin/Encryptor_byte_test_testCases.bin"
    ...
    for i in range(number):
        ...
        encByte = aesWrapper_v2.Encryptor(password).encrypt_byte(byte)
...
def main2():
    ...
    fileName = "binFiles/aesWrapper_v2_testcases_bin/Encryptor_byte_yield_test_testCases.bin"
    ...
    for i in range(number):
        ...
        genObj = aesWrapper_v2.Encryptor(password).encrypt_byte_yield(byte)
