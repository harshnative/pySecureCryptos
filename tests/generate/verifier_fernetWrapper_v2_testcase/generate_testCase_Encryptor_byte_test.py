...
def main():
    ...
    fileName = "binFiles/verifier_fernetWrapper_v2_testcases_bin/Encryptor_byte_test_testCases.bin"
    ...
    for i in range(number):
        ...
        encByte = verifier_fernetWrapper_v2.Encryptor(password).encrypt_byte(byte)
...
def main2():
    ...
    fileName = "binFiles/verifier_fernetWrapper_v2_testcases_bin/Encryptor_byte_yield_test_testCases.bin"
    ...
    for i in range(number):
        ...
        genObj = verifier_fernetWrapper_v2.Encryptor(password).encrypt_byte_yield(byte)
