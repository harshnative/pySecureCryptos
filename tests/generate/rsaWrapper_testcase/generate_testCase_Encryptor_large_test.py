...
def main():
    ...
    for i in range(number):
        ...
        genObj = rsaWrapper.Encryptor(GetKey.keyPublic , GetKey.keyPrivate).encrypt_lbyte_yield(randomByte)
    ...
    for i in range(number):
        ...
        genObj = rsaWrapper.Encryptor(GetKey.keyPublic_str , GetKey.keyPrivate_str).encrypt_lbyte_yield(randomByte)
...
def main2():
    ...
    for i in range(number):
        ...
        genObj = rsaWrapper.Encryptor(GetKey.keyPublic , GetKey.keyPrivate).encrypt_lstring_yield(randomString)
    ...
    for i in range(number):
        ...
        genObj = rsaWrapper.Encryptor(GetKey.keyPublic_str , GetKey.keyPrivate_str).encrypt_lstring_yield(randomString)
