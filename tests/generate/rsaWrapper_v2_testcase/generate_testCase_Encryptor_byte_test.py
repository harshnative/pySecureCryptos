...
def main():
    ...
    fileName = "binFiles/rsaWrapper_v2_testcases_bin/Encryptor_byte_test_testCases.bin"
    ...
    for i in range(number):
        ...
        encByte = rsaWrapper_v2.Encryptor(GetKey.keyPublic , GetKey.keyPrivate).encrypt_byte(byte)
    ...
    for i in range(number):
        ...
        encByte = rsaWrapper_v2.Encryptor(GetKey.keyPublic_str , GetKey.keyPrivate_str).encrypt_byte(byte)
...
def main2():
    ...
    fileName = "binFiles/rsaWrapper_v2_testcases_bin/Encryptor_byte_yield_test_testCases.bin"
    ...
    for i in range(number):
        ...
        genObj = rsaWrapper_v2.Encryptor(GetKey.keyPublic , GetKey.keyPrivate).encrypt_byte_yield(byte)
    ...
    for i in range(number):
        ...
        genObj = rsaWrapper_v2.Encryptor(GetKey.keyPublic_str , GetKey.keyPrivate_str).encrypt_byte_yield(byte)
