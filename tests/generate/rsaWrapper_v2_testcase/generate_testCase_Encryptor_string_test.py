...
def main():
    ...
    fileName = "binFiles/rsaWrapper_v2_testcases_bin/Encryptor_string_test_testCases.bin"
    ...
    for i in range(number):
        ...
        enc_string = rsaWrapper_v2.Encryptor(GetKey.keyPublic , GetKey.keyPrivate).encrypt_string(string)
    ...
    for i in range(number):
        ...
        enc_string = rsaWrapper_v2.Encryptor(GetKey.keyPublic_str , GetKey.keyPrivate_str).encrypt_string(string)
...
def main2():
    ...
    fileName = "binFiles/rsaWrapper_v2_testcases_bin/Encryptor_string_yield_test_testCases.bin"
    ...
    for i in range(number):
        ...
        genObj = rsaWrapper_v2.Encryptor(GetKey.keyPublic , GetKey.keyPrivate).encrypt_string_yield(string)
    ...
    for i in range(number):
        ...
        genObj = rsaWrapper_v2.Encryptor(GetKey.keyPublic_str , GetKey.keyPrivate_str).encrypt_string_yield(string)
