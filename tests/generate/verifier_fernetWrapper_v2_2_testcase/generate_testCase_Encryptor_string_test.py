...
def main():
    ...
    for i in range(number):
        ...
        enc_string = verifier_fernetWrapper_v2_2.Encryptor(password).encrypt_string(string)
...
def main2():
    ...
    for i in range(number):
        ...
        genObj = verifier_fernetWrapper_v2_2.Encryptor(password).encrypt_string_yield(string)
