...
def test_compatible():
    ...
    fileName = "binFiles/hashers_testcases_bin/sha256_test_testCases.bin"
    ...
    for byte , hashed_byte , hashed_byte_yield , hashed_string , hashed_string_yield in pickledList:
        ...
        new_hashed_byte = hashers.SHA256(byte).get_byte()
